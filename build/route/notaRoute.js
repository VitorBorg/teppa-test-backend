...
//import services
var service = require("../service/notaService");
//routes
...
router.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, service.get(req.params.id)];
            case 1:
                posts = _a.sent();
                res.status(200).json(posts);
                return [2 /*return*/];
...
router.post("/save", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
                return [4 /*yield*/, service.save(data)];
            case 1:
                posts = _a.sent();
                res.status(200).json(posts);
                return [2 /*return*/];
...
router.put("/save/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, posts;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
                return [4 /*yield*/, service.update(req.params.id, data)];
            case 1:
                posts = _a.sent();
                res.status(200).json(posts);
                return [2 /*return*/];
